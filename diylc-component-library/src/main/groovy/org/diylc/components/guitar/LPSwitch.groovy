...
//
//	private static Size BASE_WIDTH = new Size(0.5d, SizeUnit.in);
...
//	private static Size TERMINAL_LENGTH = new Size(3d, SizeUnit.mm);
//	private static Size TERMINAL_SPACING = new Size(0.1d, SizeUnit.in);
//	private static Size TERMINAL_THICKNESS = new Size(0.02d, SizeUnit.in);
//
...
//		int baseLength = (int) BASE_LENGTH.convertToPixels();
//		
//		controlPoints[1].setLocation(x - terminalSpacing * 2 - baseLength, y - terminalSpacing);
//		controlPoints[2].setLocation(x - terminalSpacing * 2 - baseLength, y);
//		controlPoints[3].setLocation(x - terminalSpacing * 2 - baseLength, y);
//
//		// Rotate if needed
//		if (orientation != Orientation.DEFAULT) {
//			double theta = 0;
