...
public class GroundFill extends AbstractComponent<Void> {
	...
	protected Point[] controlPoints = [ new Point(0, 0), new Point(0, (int) DEFAULT_HEIGHT.convertToPixels()),
	...
	public void draw(GraphicsContext graphicsContext, ComponentState componentState,
		...
		Color fillColor = componentState == ComponentState.SELECTED || componentState == ComponentState.DRAGGING ? SELECTION_COLOR : color
