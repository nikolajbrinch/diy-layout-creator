...
public class PlasticDCJack extends AbstractTransparentComponent<String> implements Geometry {
	...
	private Point[] controlPoints = [ new Point(0, 0),
			new Point(0, 0), new Point(0, 0) ] as Point[]
	...
	public Shape[] getBody() {
		if (body == null) {
			...
			body[1] = rectangle(x - rectWidth / 2, y + spacing - rectWidth
	...
	public void drawIcon(GraphicsContext graphicsContext, int width, int height) {
		...
		graphicsContext.fillOval((width - lugWidth) / 2, height * 2 / 3 - lugWidth / 2,
				lugWidth, lugWidth)
		graphicsContext.fillRect(width / 2 - lugWidth * 3 / 2, height * 2 / 3 - lugWidth
