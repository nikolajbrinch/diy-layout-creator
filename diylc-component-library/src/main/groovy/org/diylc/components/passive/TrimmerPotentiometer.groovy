...
@ComponentDescriptor(name = "Trimmer Potentiometer", author = "Branislav Stojkovic", category = "Passive", instanceNamePrefix = "VR", description = "Various types of board mounted trimmer potentiometers")
