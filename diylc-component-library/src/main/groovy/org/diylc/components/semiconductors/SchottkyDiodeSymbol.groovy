...
@ComponentDescriptor(name = "Schottky diode (schematic symbol)", author = "Branislav Stojkovic", category = "Schematics", instanceNamePrefix = "D", description = "Schottky diode schematic symbol")
