...
@ComponentDescriptor(name = "Diode (schematic symbol)", author = "Branislav Stojkovic", category = "Schematics", instanceNamePrefix = "D", description = "Diode schematic symbol")
