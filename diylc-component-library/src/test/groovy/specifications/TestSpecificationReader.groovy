...
import org.diylc.specifications.registry.SpecificationReader;
...
public class TestSpecificationReader {
    ...
    public void test4013in() throws JsonParseException, JsonMappingException, IOException {
        Specification value = new SpecificationReader().read(new File("./src/main/resources/specifications/ic/4013.spec"))
    ...
    public void testAllIn() throws JsonParseException, JsonMappingException, IOException {
        ...
        models.each { String model ->
            ...
            Specification value = reader.read(new File("./src/main/resources/specifications/ic/${model}.spec"))
            assertEquals("IC", value.category)
