...
public abstract class AbstractCurvedComponent extends AbstractTransparentComponent {
    ...
    protected Point[] controlPoints = new Point[] { new Point(0, 0), new Point((int) (DEFAULT_SIZE.convertToPixels() / 2), 0),
     ...
     */
    protected abstract void drawCurve(CubicCurve2D curve, GraphicsContext graphicsContext, ComponentState componentState);
    ...
    public void drawIcon(GraphicsContext graphicsContext, int width, int height) {
        ...
        CubicCurve2D curve = new CubicCurve2D.Double(1, height - 1, width / 4, height / 3, 3 * width / 4, 2 * height / 3, width - 1, 1);
    ...
    public void draw(GraphicsContext graphicsContext, ComponentState componentState, boolean outlineMode, Project project,
        ...
        if (componentState == ComponentState.SELECTED || componentState == ComponentState.DRAGGING) {
            ...
            graphicsContext.drawLine(controlPoints[0].x, controlPoints[0].y, controlPoints[1].x, controlPoints[1].y);
            graphicsContext.drawLine(controlPoints[1].x, controlPoints[1].y, controlPoints[2].x, controlPoints[2].y);
            graphicsContext.drawLine(controlPoints[2].x, controlPoints[2].y, controlPoints[3].x, controlPoints[3].y);
            drawingObserver.startTracking();
        }
        CubicCurve2D curve = new CubicCurve2D.Double(controlPoints[0].x, controlPoints[0].y, controlPoints[1].x, controlPoints[1].y,
