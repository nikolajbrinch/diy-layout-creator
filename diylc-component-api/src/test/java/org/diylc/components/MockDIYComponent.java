...
public class MockDIYComponent extends AbstractComponent {
	...
	public void draw(GraphicsContext graphicsContext, ComponentState componentState, boolean outlineMode,
	    ...
	    graphicsContext.setColor(componentState.equals(ComponentState.SELECTED) ? color : color.darker());
	    graphicsContext.fillRect(leftTopCorner.x, leftTopCorner.y, 200, 50);
	}

	@Override
	public void drawIcon(GraphicsContext graphicsContext, int width, int height) {
	    graphicsContext.drawString("X", 10, 10);
	}
}
