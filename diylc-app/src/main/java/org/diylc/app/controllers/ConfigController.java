...
public class ConfigController extends AbstractController {
  ...
  public ConfigController(ApplicationController applicationController, View view, Model model,
  ...
  public void continuousCreation(ActionEvent event) {
    JCheckBoxMenuItem menuItem = (JCheckBoxMenuItem) event.getSource();
    Configuration.INSTANCE.setProperty(Configuration.Key.CONTINUOUS_CREATION,
        menuItem.isSelected());
    getPlugInPort().refresh();
  }
