...
public interface View {
  ...
  /**
   * Adds a custom menu action into application's main menu. If <code>action</code> is set to null
  ...
  /**
   * Adds a custom submenu into application's main menu. If <code>action</code> is set to null
   * {@link Separator} will be added. If the specified menu does not exist it will be automatically
   * created.
   * 
   * @param name
