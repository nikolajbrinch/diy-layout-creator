...
public class LinkLabel extends JLabel {
  ...
  /**
   * Creates a hyperlink with the specified url and protocol. For web page links use <br>
   * <br>
   ...
   * <br>
   * Other constructors should not be used as they will create a plain {@link JLabel}.
   * 
   * @param protocol
   * @param url
   */
  public LinkLabel(final String protocol, final String url) {
    ...
    addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        try {
          BrowserUtils.openURL(protocol + url);
        } catch (Exception e1) {
