...
public class CanvasPanel extends JComponent implements Autoscroll {
	...
	public void paint(Graphics g) {
		...
		Set<DrawingOption> drawOptions = EnumSet.of(DrawingOption.GRID,
				DrawingOption.SELECTION, DrawingOption.ZOOM,
				DrawingOption.CONTROL_POINTS);
		if (Configuration.INSTANCE.getAntiAliasing()) {
			drawOptions.add(DrawingOption.ANTIALIASING);
		}
