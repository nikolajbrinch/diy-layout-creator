...
class ComponentButtonFactory {
  ...
  public static JButton create(final IPlugInPort plugInPort, final ComponentType componentType,
    ...
    button.setToolTipText("<html><b>" + componentType.getName() + "</b><br>"
        + componentType.getDescription() + "<br>Author: "
        + componentType.getAuthor() + "<br><br>Right click to select all components of this type"
        + "</html>");
  ...
  public static JMenuItem createTemplateItem(final IPlugInPort plugInPort, final Template template,
    ...
    label.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        plugInPort.deleteTemplate(componentType.getCategory(), componentType.getName(),
            template.getName());
        e.consume();
      }
    });
