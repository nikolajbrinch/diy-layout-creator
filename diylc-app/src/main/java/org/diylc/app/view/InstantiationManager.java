...
public class InstantiationManager {
  ...
  private static final ComponentType clipboardType =
      new ComponentType("Clipboard contents", "Components from the clipboard",
          CreationMethod.SINGLE_CLICK, "Multi", "", "", null, null, 0, false, false, null, false,
          true);
  ...
  public void setComponentTypeSlot(ComponentType componentTypeSlot, Template template,
  ...
  public void instatiatePointByPoint(Point scaledPoint, Project currentProject) throws Exception {
    ...
    /*
     * Set the other control point to the same location, we'll move it later when mouse moves.
     */
  ...
  public void pasteComponents(List<IDIYComponent> components, Point scaledPoint, boolean snapToGrid,
      Size gridSpacing) {
    /*
     * Adjust location of components so they are centered under the mouse cursor
     */
    ...
    /*
     * Update the component type slot so the app knows that something's being instantiated.
     */
  ...
  public List<IDIYComponent> instantiateComponent(ComponentType componentType, Template template,
      Point point, Project currentProject)
      throws Exception {
    LOG.trace("Instatiating component of type: " + componentType.getInstanceClass().getName());
