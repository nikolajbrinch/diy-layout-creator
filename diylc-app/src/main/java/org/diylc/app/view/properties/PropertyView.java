...
public class PropertyView extends JComponent {
  ...
  private Color getLabelBackgroundColor() {
    if (labelBackgroundColor == null) {
      ...
      labelBackgroundColor = new Color(backgroundColor.getRed() - 8, backgroundColor.getGreen() - 8,
          backgroundColor.getBlue() - 8,
  ...
  private Object translateValue(Object value, PropertyWrapper property,
