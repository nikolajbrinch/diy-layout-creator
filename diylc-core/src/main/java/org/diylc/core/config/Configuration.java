...
public enum Configuration {
    ...
    public static enum Key {
        SHOW_TEMPLATES("showTemplatesAtStartup"), THEME("theme"), LAST_PATH("lastPath"), WINDOW_BOUNDS("windowBounds"), ABNORMAL_EXIT(
    ...
    public boolean getPropertyPanel() {
        return getBooleanProperty(Key.PROPERTY_PANEL, false);
    }
    ...
    public WindowBounds getWindowBounds() {
        ...
        Map<String, Integer> windowBounds = (Map<String, Integer>) getObjectProperty(Key.WINDOW_BOUNDS, defaultWindowBounds);
        ...
        return new WindowBounds(windowBounds.get("x"), windowBounds.get("y"), windowBounds.get("width"), windowBounds.get("height"),
