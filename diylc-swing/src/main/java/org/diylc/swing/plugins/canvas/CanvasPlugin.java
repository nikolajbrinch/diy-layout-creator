...
public class CanvasPlugin implements IPlugIn, ClipboardOwner {
        ...
        if (canvasPanel == null) {
            ...
            canvasPanel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    plugInPort.mouseClicked(e.getPoint(), e.getButton(), e.isControlDown(), e.isShiftDown(), e.isAltDown(), e.isMetaDown(),
                            e.getClickCount());
                }
            });
        }
    ...
    public JPopupMenu getPopupMenu() {
        if (popupMenu == null) {
            ...
            popupMenu.addSeparator();
            popupMenu.add(ActionFactory.INSTANCE.createEditProjectAction(plugInPort));
        }
        return popupMenu;
    }
    ...
    public ActionFactory.RotateSelectionAction getRotateClockwiseAction() {
        if (rotateClockwiseAction == null) {
            rotateClockwiseAction = ActionFactory.INSTANCE.createRotateSelectionAction(plugInPort, 1);
        }
    ...
    public ActionFactory.RotateSelectionAction getRotateCounterclockwiseAction() {
        if (rotateCounterclockwiseAction == null) {
            rotateCounterclockwiseAction = ActionFactory.INSTANCE.createRotateSelectionAction(plugInPort, -1);
        }
    ...
    public ActionFactory.GroupAction getGroupAction() {
        if (groupAction == null) {
            groupAction = ActionFactory.INSTANCE.createGroupAction(plugInPort);
        }
        return groupAction;
    }
    ...
    public ActionFactory.UngroupAction getUngroupAction() {
        if (ungroupAction == null) {
            ungroupAction = ActionFactory.INSTANCE.createUngroupAction(plugInPort);
        }
    ...
    public ActionFactory.BringToFrontAction getBringToFrontAction() {
        if (bringToFrontAction == null) {
            bringToFrontAction = ActionFactory.INSTANCE.createBringToFrontAction(plugInPort);
        }
